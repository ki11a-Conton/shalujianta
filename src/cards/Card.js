...
export class Card {
     ...
     * @param {number} damageMultiplier - 伤害倍率（默认1）
     ...
     * @param {Entity} target - 目标
     * @param {GameState} gameState - 游戏状态
     * @param {number} damageMultiplier - 伤害倍率
     */
                ...
                case 'double_poison':
                    if (target) {
                        ...
                        if (currentPoison > 0) {
                            ...
                            console.log(`催化剂：中毒层数翻倍，从 ${currentPoison} 变为 ${currentPoison * 2}`);
                        }
                    }
                    break;
                ...
                case 'poison_bonus':
                    if (target) {
                        ...
                        if (currentPoison > 0) {
                            ...
                            console.log(`毒刺：目标中毒，额外造成 ${effect.value} 点伤害`);
                        }
                    }
                    break;
